...
static std::string immValU8(const GameBoy& gb, uint16_t pc)
{
    return uintToHex(gb.read8(pc));
}

static std::string immValS8(const GameBoy& gb, uint16_t pc)
{
...
std::string GBDebug::symbolOrU16(const GameBoy& gb, uint16_t pc)
{
...
std::string GBDebug::symbolOrS8(const GameBoy& gb, uint16_t pc)
{
...
std::string GBDebug::updateInstructionToStr(const GameBoy& gb)
{
...
std::string GBDebug::instructionToStr(const GameBoy& gb)
{
    // opcode reference: 
...
std::string GBDebug::instructionCBToStr(const GameBoy& gb)
{
