...
uint8_t CPU::execute(uint8_t opcode, bool& ok)
{
    ...
    switch(opcode) {
        ...
        case op::LD_B_inHL    : return opLdInd(regs.B); // LD B,[HL]
        ...
        case op::LD_C_inHL    : return opLdInd(regs.C); // LD C,[HL]
        ...
        case op::LD_D_inHL    : return opLdInd(regs.D); // LD A,[HL]
        ...
        case op::LD_E_inHL    : return opLdInd(regs.E); // LD E,[HL]
        ...
        case op::LD_H_inHL    : return opLdInd(regs.H); // LD H,[HL]
        ...
        case op::LD_L_inHL    : return opLdInd(regs.L); // LD L,[HL]
        ...
        case op::LD_A_inHL    : return opLdInd(regs.A); // LD A,[HL]
